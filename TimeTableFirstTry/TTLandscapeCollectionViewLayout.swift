...
//  Timetable App
//
//  Created by Aurel Feer and Lukas Boner on 13.12.15.
...
class TTLandscapeCollectionViewLayout: TTCollectionViewLayout {
    ...
    */
    override func widthForItemWithColumn(_ column: Int) -> CGFloat {
    ...
    */
    override func heightForItemWithSection(_ section: Int) -> CGFloat {
        if section == 0 {
            return CGFloat(30)
        } else {
            return CGFloat(40)
